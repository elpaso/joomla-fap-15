...
class AccesskeysControllerAccesskeys extends AccesskeysController {
	...
	function save() {
        ...
        // Get Var
		if($model->store()) {
			$msg = JText::_('Access Key Saved');
		} else {
			$msg = JText::_('Error Saving Access Key') . ': ' . $model->getError();
		}
	...
	function remove() {
        ...
        // Get Var
		if($model->remove()) {
			$msg = JText::_('Access Key Deleted');
		} else {
			$msg = JText::_('Error Deleting Access Key') . ': ' . $model->getError();
		}
