...
<div class="cpotitle contentpaneopen<?php echo $_tpl_params->get( 'pageclass_sfx' ); ?>">
		...
		<div>
			<div>
				<?php if ($_tpl_params->get('link_titles') && $this->item->readmore_link != '') : ?>
					<h<?php echo $item_title_level;?>><a href="<?php echo $this->item->readmore_link; ?>" class="contentpagetitle<?php echo $_tpl_params->get( 'pageclass_sfx' ); ?>"><?php echo JFilterOutput::ampReplace($this->item->title); ?></a></h<?php echo $item_title_level;?>>
				<?php else : ?>
...
<div>
	<div>
		...
		<span>
			<?php echo JFilterOutput::ampReplace($this->item->category); ?>
		</span>
		<?php endif; ?>
 </div>
</div>
    ...
    <div>
        <a href="<?php echo $this->item->readmore_link; ?>" class="readon<?php echo $this->item->params->get('pageclass_sfx'); ?>">
            ...
            elseif ($readmore = $this->item->params->get('readmore')) :
                ...
                echo JText::sprintf('Read more', JFilterOutput::ampReplace($this->item->title));
            endif; ?></a>
    </div>
</div>
<?php endif; ?>
