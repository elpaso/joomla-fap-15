<?php
/**
 * $Id: default.php 36 2008-04-03 06:26:47Z elpaso $
 */
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<?php if ($this->params->get( 'show_headings' )) : ?>
		<tr>
			<th scope="col"  width="5" align="right" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
				<?php echo JText::_('Num'); ?>
			</th>
			<th scope="col"  height="20" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
			...
			<th scope="col"  height="20" width="20%" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
				<?php echo JText::_( 'Email' ); ?>
			</th>
			<?php endif; ?>
			<?php if ( $this->params->get( 'show_telephone' ) ) : ?>
			<th scope="col"  height="20" width="15%" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
