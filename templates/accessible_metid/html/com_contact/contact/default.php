<?php
/**
 * $Id: default.php 73 2008-09-17 09:52:52Z elpaso $
 */
defined( '_JEXEC' ) or die( 'Restricted access' );

$cparams = JComponentHelper::getParams ('com_media');

//var_dump($this->params->get( 'show_name' ));die();
?>
...
<table style="width:100%" cellpadding="0" cellspacing="0" border="0" class="contentpaneopen<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
...
<tr>
	<td style="width:100%" class="contentheading<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
		...
		<tr>
			...
			<?php if ( $this->contact->image && $this->contact->params->get( 'show_image' ) ) : ?>
				<div style="float: right;">
					<?php echo JHTML::_('image', $cparams->get('image_path') . '/'.$this->contact->image, JText::_( 'Contact' ), array('style' => 'align:middle')); ?>
				</div>
			<?php endif; ?>
			</td>
		</tr>
