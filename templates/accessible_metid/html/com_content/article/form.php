<?php // @version: $Id: form.php 34 2008-03-13 14:39:43Z elpaso $
...
<legend><?php echo JText::_('Editor'); ?></legend>
		...
		<div style="display:inline;">
			...
			<input class="inputbox" type="text" id="title" name="title" size="70" maxlength="255" value="<?php echo $this->escape($this->article->title); ?>" />
		</div>                   
		<div class="wrap">&nbsp;</div>
...
<br/>
<fieldset class="metadata" style='display:none;'>
<legend><?php echo JText::_('Metadata'); ?></legend>


		<label for="metadesc" style="vertical-align:top;">
		...
		<label for="metakey" style="vertical-align:top;">
