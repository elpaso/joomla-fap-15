...
<form action="<?php echo htmlentities($this->action); ?>" method="post" id="adminForm">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <th scope="col" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>" style="align:right;width:5%">
      ...
      <th align="center" class="sectiontableheader<?php echo $this->params->get( 'pageclass_sfx' ); ?>" style="width:5%;white-space:nowrap;">
